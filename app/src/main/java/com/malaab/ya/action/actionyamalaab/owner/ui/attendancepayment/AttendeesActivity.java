...
public class AttendeesActivity extends BaseActivity implements AttendeesMvpView {
...
//    }
    ...
    public void OnEventItemClicked(OnEventItemClicked event) {
        if (TheActivityManager.getInstance().getCurrentActivity() instanceof AttendeesActivity) {
            if (event.getItem() instanceof Booking) {
                ...
                ActivityUtils.goTo(AttendeesActivity.this, UsersDetailsActivity.class, false, bundle);
            }
        }
    }
