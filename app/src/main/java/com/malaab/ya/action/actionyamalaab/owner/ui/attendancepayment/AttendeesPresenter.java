...
public class AttendeesPresenter<V extends AttendeesMvpView>
    ...
    public AttendeesPresenter(DataManager dataManager, SchedulerProvider schedulerProvider, CompositeDisposable compositeDisposable, IAnalyticsTracking iAnalyticsTracking, IFirebaseTracking iFirebaseTracking) {
        ...
        iAnalyticsTracking.LogEventScreen("Android - Owner - Attendees Screen");
        iFirebaseTracking.LogEventScreen("Android - Owner - Attendees Screen");
    }
    ...
    public void getFullBookings(String userUid) {
        ...
        mDatabase.orderByChild("ownerId_status")
                .equalTo(criteria)
...
//                                        }
    ...
    public void createFine(final Booking booking) {
        ...
        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference(Constants.FIREBASE_DB_FINES_TABLE).child(booking.userId).push();
        mDatabase
                .setValue(fine)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
